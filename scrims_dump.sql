...
--
-- Table structure for table `medias_jogadores`
--

DROP TABLE IF EXISTS `medias_jogadores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `medias_jogadores` (
  `id` int NOT NULL AUTO_INCREMENT,
  `player_name` varchar(255) NOT NULL,
  `media_eliminacoes` float DEFAULT NULL,
  `media_mortes` float DEFAULT NULL,
  `media_assistencias` float DEFAULT NULL,
  `media_dano` float DEFAULT NULL,
  `media_plantacoes` float DEFAULT NULL,
  `media_desarmamentos` float DEFAULT NULL,
  `media_vitorias` float DEFAULT NULL,
...
--
-- Dumping data for table `medias_jogadores`
--

LOCK TABLES `medias_jogadores` WRITE;
/*!40000 ALTER TABLE `medias_jogadores` DISABLE KEYS */;
INSERT INTO `medias_jogadores` VALUES (1,'dimatefps',5.25641,6.97436,2.58974,1110.92,2.02564,0.128205,0.384615,39),(2,'I__LOTUS__I',6.21053,7.52632,2.26316,1470.74,0.894737,0.157895,0.473684,19),(3,'Jeff_-SZ',7.81818,4.95455,2.63636,1234.86,0.318182,0.590909,0.681818,22),(4,'Difurent',6.9375,5.0625,2.5625,1314.69,0.8125,0.5625,0.5625,16),(5,'maYumeSenpai',9.72727,4.27273,3,1863.82,0.272727,0.545455,0.818182,11),(6,'Zit4l0_AKaA_',9.5,7.2,3.9,1887.5,0,0.3,0.6,10),(7,'Rovenita',5.42857,7.57143,2.71429,1483.86,2.14286,0.285714,0.571429,7),(8,'Difurent Feliz',15.5,5.75,4.75,2581.5,0.25,0.25,0.5,4),(9,'Marcosfox375',6.57143,7.71429,4.42857,1405.29,0.857143,0.428571,0.285714,7),(10,'Zi1379',2.75,7.25,1.4375,597.562,0.5625,0.1875,0.5,16),(11,'escanor bravo',18,8.66667,3.66667,2938.33,0,0.333333,0.666667,3),(12,'New ToddynhoRx12',6.25,5.5,2.875,1066.38,1.375,0.125,0.625,8),(13,'STORM-APPROACHIN',15,9.33333,4.66667,2785,0,0.333333,0.666667,3),(14,'Froppado',5.5,8.5,2.66667,1019,0.666667,0.333333,0.333333,6),(15,'Shadow_JH37',9.66667,8,5.66667,1726.67,0.333333,0.333333,0.333333,3),(16,'RevengerFox68',6.25,7.25,1.25,1254.75,1,1,0.25,4),(17,'twitch JOYSTIIIK',8.33333,7.33333,6.33333,1655.67,0,0.333333,0.666667,3),(18,'SOUZAJRO11',9,7.66667,7.66667,1630.33,0,0.333333,0.666667,3),(19,'luizrated',10.6667,9,4.33333,1610.33,0,0.666667,0.666667,3),(20,'Nicollas_M2808',2.875,5.125,2.875,575.25,0.25,0.375,0.5,8),(21,'zCesar_Jrz',8.33333,8.33333,4.66667,1499.33,0,0,0.666667,3),(22,'zaupgn',4,6,3.25,1096.25,1,0.5,0.75,4),(23,'Faze_TR3M1D1NH4',7,8.66667,5,1333.33,2,0,0.333333,3),(24,'Carloncho 2',7,6.33333,3.33333,1164.33,0.666667,0,0.666667,3),(25,'Rip_Hiroshy4',2.8,6.2,1,616.2,0,0,0.2,5),(26,'Rafaelln96',9,2,4,2578,1,1,1,1),(27,'NerO_X',4.66667,8.33333,4.33333,827,2.66667,0,0.666667,3),(28,'SaneAtol16282',1.18182,5.90909,1.81818,215.364,0.0909091,0.0909091,0.0909091,11),(29,'Zi1369',3.75,6.5,1.5,589,0,0,0.5,4),(30,'nuviuss',12,8,6,2279,1,1,1,1),(31,'Cusssing',4.5,7.5,4.5,971.5,0,0,0.5,2),(32,'ZAllOOS',14,10,6,1909,2,0,1,1),(33,'DentedoSiso',13,4,1,1742,0,0,1,1),(34,'JoãoOrtega',10,2,4,1684,1,1,1,1),(35,'Thormenttus',1.4,2.4,1.4,320,0,0,0.4,5),(36,'Eo_angelo',8,5,3,1171,1,0,1,1),(37,'elpina1546',4,10,6,949,0,0,1,1),(38,'LuamZoka',8,7,1,947,0,0,0,1),(39,'Reboco D Cimento',7,8,1,939,1,0,0,1),(40,'DEIVAOgamer',4,5,6,933,0,0,1,1),(41,'Soledy_Andre-_-T',4,9,3,928,0,0,0,1),(42,'zc_Xardas',2,9,1,770,0,0,0,1),(43,'MaxDetonade',3,8,2,753,0,0,0,1),(44,'Pastorplay5765',3,7,4,722,0,0,1,1),(45,'Romulando_',2,6,5,623,0,0,1,1),(46,'Black_noiir_',3,7,0,556,0,0,0,1),(47,'BodePoeta',2,7,1,409,0,0,0,1),(48,'Jairochaos',0,8,3,392,1,0,0,1),(49,'Taelgamer007',0,8,2,260,0,0,0,1),(50,'jmpalaciosv',0,8,1,100,0,0,0,1),(51,'los_vagos836',0,0,0,0,0,0,0,1);
/*!40000 ALTER TABLE `medias_jogadores` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-27 13:37:11
